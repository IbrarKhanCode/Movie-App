...
class ThorScreen extends StatefulWidget {
  const ThorScreen({super.key});

  @override
  State<ThorScreen> createState() => _ThorScreenState();
}

class _ThorScreenState extends State<ThorScreen> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Hero(
                    tag: 'thor',
                    child: Image.asset('images/thor.png',fit: BoxFit.cover,)),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Thor",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

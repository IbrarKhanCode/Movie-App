...
class IronManScreen extends StatefulWidget {
  ...
  @override
  State<IronManScreen> createState() => _IronManScreenState();
}
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Hero(
                    tag: 'iron man',
                    child: Image.asset('images/iron man.png',fit: BoxFit.cover,)),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Iron Man",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

...
class DoctorStrangeScreen extends StatefulWidget {
  const DoctorStrangeScreen({super.key});

  @override
  State<DoctorStrangeScreen> createState() => _DoctorStrangeScreenState();
}

class _DoctorStrangeScreenState extends State<DoctorStrangeScreen> {
  @override
      ...
      body:  Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Hero(
                    tag: 'doctor strange',
                    child: Image.asset('images/doctor strange.png',fit: BoxFit.cover,)),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Doctor Strange",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(
                ...
                itemBuilder: (context,ind){
                  return Padding(
                    ...
                    child: Container(
                      ...
                      width: 150,
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('images/doctor strange.png'),
                            fit: BoxFit.cover,
                          ),
                          borderRadius: BorderRadius.circular(15)
                      ),

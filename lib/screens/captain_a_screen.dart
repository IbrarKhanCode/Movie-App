...
class CaptainAScreen extends StatefulWidget {
  const CaptainAScreen({super.key});

  @override
  State<CaptainAScreen> createState() => _CaptainAScreenState();
}

class _CaptainAScreenState extends State<CaptainAScreen> {
  @override
        ...
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Hero(
                    tag: 'captain america',
                    child: Image.asset('images/captain america.png',fit: BoxFit.cover,)),
              ),
              Positioned(
                top: 50,
                  left: 20,
          ...
          Row(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Captain America",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
                ],
              ),
            ),
          Padding(

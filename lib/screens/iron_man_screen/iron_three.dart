...
class IronThree extends StatefulWidget {
  const IronThree({super.key});

  @override
  State<IronThree> createState() => _IronThreeState();
}

class _IronThreeState extends State<IronThree> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/iron 3.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Iron Man Three",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(
                ...
                itemBuilder: (context,ind){
                  return Padding(
                    ...
                    child: Container(
                      ...
                      width: 150,
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('images/iron man.png'),
                            fit: BoxFit.cover,
                          ),
                          borderRadius: BorderRadius.circular(15)
                      ),

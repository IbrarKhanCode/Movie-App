...
class LoveAndThunder extends StatefulWidget {
  const LoveAndThunder({super.key});

  @override
  State<LoveAndThunder> createState() => _LoveAndThunderState();
}

class _LoveAndThunderState extends State<LoveAndThunder> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/thor 4.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Thor Love And Thunder",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(
                ...
                itemBuilder: (context,ind){
                  return Padding(
                    ...
                    child: Container(
                      ...
                      width: 150,
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('images/thor.png'),
                            fit: BoxFit.cover,
                          ),
                          borderRadius: BorderRadius.circular(15)
                      ),

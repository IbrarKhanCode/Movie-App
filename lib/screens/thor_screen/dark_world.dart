...
class DarkWorld extends StatefulWidget {
  const DarkWorld({super.key});

  @override
  State<DarkWorld> createState() => _DarkWorldState();
}

class _DarkWorldState extends State<DarkWorld> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/thor 2.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Thor The Dark World",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

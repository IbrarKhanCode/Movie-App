...
class ThorRagnarok extends StatefulWidget {
  const ThorRagnarok({super.key});

  @override
  State<ThorRagnarok> createState() => _ThorRagnarokState();
}

class _ThorRagnarokState extends State<ThorRagnarok> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/thor 3.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Thor Ragnarok",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

...
class ThorOne extends StatefulWidget {
  const ThorOne({super.key});

  @override
  State<ThorOne> createState() => _ThorOneState();
}

class _ThorOneState extends State<ThorOne> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/thor 1.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("Thor One",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

...
class FirstAvenger extends StatefulWidget {
  const FirstAvenger({super.key});

  @override
  State<FirstAvenger> createState() => _FirstAvengerState();
}

class _FirstAvengerState extends State<FirstAvenger> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/captain 1.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("The First Avenger",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(

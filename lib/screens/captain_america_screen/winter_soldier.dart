...
class WinterSoldier extends StatefulWidget {
  const WinterSoldier({super.key});

  @override
  State<WinterSoldier> createState() => _WinterSoldierState();
}

class _WinterSoldierState extends State<WinterSoldier> {
  @override
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                ...
                child: Image.asset('images/captain 2.png',fit: BoxFit.cover,),
              ),
              Positioned(
                  top: 50,
                  left: 20,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text("The Winter Soldier",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 23),),
              ],
            ),
          ),
          Padding(
